...
test('PWA V8.7 usa shell 57 y conserva assets de supervisión + jerarquía', () => {
  assert.match(sw, /smart-inventory-v2-shell-59/);
  ...
  assert.match(sw, /operationalDate\.js/);
  assert.match(sw, /supplyHistoryGrouping\.js/);
});
